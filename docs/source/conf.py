...
htmlhelp_basename = 'pygendoc'


# -- Options for LaTeX output --------------------------------------------------
mypreamble=open('preamble.tex', 'r').read()
...
# not chapters.
latex_use_parts = False    # False redsults in more compact document
...
pdf_stylesheets = ['a4_','kerning_2', 'sphinx_2']# , 'double-sided']
# pdf_stylesheets = ['printed_stylesheet']
...
# If false, no index is generated.
pdf_use_index = True # there are no page numbers, only links.
...
pdf_cover_template = 'KITInternalReport.tmpl'
...
pdf_page_template = 'KITInternalReport'
